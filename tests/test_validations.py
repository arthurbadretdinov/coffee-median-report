...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            invalid_row_length1,
            pytest.raises(ValueError, match="Invalid row length"),
        ),  # неправильная длина строки (меньше нужного)
        (
            invalid_row_length2,
            pytest.raises(ValueError, match="Invalid row length"),
        ),  # неправильная длина строки (больше нужного)
        (
            invalid_type,
            pytest.raises(ValueError, match="could not convert"),
